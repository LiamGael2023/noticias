...
function renderNewsCard($news, $variant = 'default') {
    if ($variant === 'featured') {
        ?>
        <article class="group relative overflow-hidden rounded-3xl bg-slate-900 h-[450px] md:h-[520px] shadow-2xl">
    ...
    if ($variant === 'secondary') {
        ?>
        <div class="group relative overflow-hidden rounded-2xl bg-slate-900 h-[220px] md:h-[248px] shadow-xl">
