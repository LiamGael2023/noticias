        ...
        <div class="container mx-auto px-4">
            ...
            <div class="flex items-center justify-between py-4">
                ...
                <div class="hidden lg:block">
                    <a href="<?= APP_URL ?>/#contacto" class="inline-flex items-center px-5 py-2.5 bg-blue-600 text-white text-sm font-semibold rounded-xl hover:bg-blue-700 transition-colors shadow-lg shadow-blue-200">
