...
<form method="POST" action="<?= APP_URL ?>/admin/news/store" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="space-y-4">
                ...
                <div>
                    <label class="flex items-center gap-3">
                        <input type="checkbox" name="featured" value="1" class="w-5 h-5 rounded border-slate-300 text-blue-600 focus:ring-blue-500">
